...
public class program_etalonari_surse
{
  // Sample average
  ...
  public static void main(String[] args)
  {
    ...
    // Date si conditii de etalonare
    System.out.print("\nResponsabil calcule: ");
    String name = scanner.nextLine();

    System.out.println("Conditii de mediu:");
    System.out.print("Temperatura (C): ");
    double temp = scanner.nextDouble();
    System.out.print("Umiditatea rel. (%): ");
    double humid = scanner.nextDouble();

    System.out.println("Conditii de masurare:");
    System.out.print("Inalta Tensiune (V): ");
    double it = scanner.nextDouble();
    System.out.print("Tensiunea de prag (mV): ");
    ...
    try (BufferedWriter writer = new BufferedWriter(new FileWriter(fileName))) {
      ...
      // ===== CONDITII DE ETALONARE =====

      writer.write("Responsabil calcule: " + name);
      writer.newLine();

      writer.write("Conditii de mediu:");
      writer.newLine();
      writer.write("  Temperatura (C): " + temp);
      writer.newLine();
      writer.write("  Umiditatea (%): " + humid);
      writer.newLine();

      writer.write("Conditii de masurare:");
      writer.newLine();
      writer.write("  IT (V): " + it);
      writer.newLine();
      writer.write("  Up (mV): " + up);
      writer.newLine();
      ...
      System.out.println("\nFisierul rezultat.txt a fost creat cu succes !\n");
